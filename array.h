...
// функция для получения значений как в работе 8
double func(double x); 

/**
 * Вычисление среднего арифметического ненулевых элементов массива
 * @param array указатель на массив
 * @param size размер массива
 * @return среднее арифметическое или NAN, если ненулевых элементов нет
 */
